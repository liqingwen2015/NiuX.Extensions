...
/// </summary>
public static partial class NiuXDayOfWeekExtensions
{
    /// <summary>
...
public static partial class NiuXDayOfWeekExtensions
{
    ...
    public static DateTime FindNthWeekDayOfMonth(this DayOfWeek dayOfWeek, int year, int month, int n)
    {
        ...
        var daysOfMonth = NiuXDateTimeExtensions.DaysOfMonth(year, month);
    ...
    {
        return NiuXDateTimeExtensions.DaysOfMonth(year, month).Count(date => dayOfWeek.Equals(date.DayOfWeek));
    }
