...
/// </summary>
public static class NiuXDateTimeExtensions
{
    /// <summary>
    ...
    /// <returns></returns>
    public static DateTime GetMaxValue(this DateTime time1, DateTime time2)
    {
    ...
    /// <param name="time2">The time2.</param>
    /// <returns></returns>
    public static DateTime GetMinValue(this DateTime time1, DateTime time2)
    {
        return time1 < time2 ? time1 : time2;
    }
    ...
    /// <summary>
    /// Determines whether this instance is week1.
    /// </summary>
    /// <param name="dateTime">The date time.</param>
    /// <returns>
    ///   <c>true</c> if the specified date time is week1; otherwise, <c>false</c>.
    /// </returns>
    public static bool IsWeek1(this DateTime dateTime)
    {
        return dateTime.DayOfWeek == DayOfWeek.Monday;
    }

    /// <summary>
    /// Determines whether this instance is week2.
    /// </summary>
    /// <param name="dateTime">The date time.</param>
    /// <returns>
    ///   <c>true</c> if the specified date time is week2; otherwise, <c>false</c>.
    /// </returns>
    public static bool IsWeek2(this DateTime dateTime)
    {
        return dateTime.DayOfWeek == DayOfWeek.Tuesday;
    }

    /// <summary>
    /// Determines whether this instance is week3.
    /// </summary>
    /// <param name="dateTime">The date time.</param>
    /// <returns>
    ///   <c>true</c> if the specified date time is week3; otherwise, <c>false</c>.
    /// </returns>
    public static bool IsWeek3(this DateTime dateTime)
    {
        return dateTime.DayOfWeek == DayOfWeek.Wednesday;
    }

    /// <summary>
    /// Determines whether this instance is week4.
    /// </summary>
    /// <param name="dateTime">The date time.</param>
    /// <returns>
    ///   <c>true</c> if the specified date time is week4; otherwise, <c>false</c>.
    /// </returns>
    public static bool IsWeek4(this DateTime dateTime)
    {
        return dateTime.DayOfWeek == DayOfWeek.Thursday;
    }

    /// <summary>
    /// Determines whether this instance is week5.
    /// </summary>
    /// <param name="dateTime">The date time.</param>
    /// <returns>
    ///   <c>true</c> if the specified date time is week5; otherwise, <c>false</c>.
    /// </returns>
    public static bool IsWeek5(this DateTime dateTime)
    {
        return dateTime.DayOfWeek == DayOfWeek.Friday;
    }

    /// <summary>
    /// Determines whether this instance is week6.
    /// </summary>
    /// <param name="dateTime">The date time.</param>
    /// <returns>
    ///   <c>true</c> if the specified date time is week6; otherwise, <c>false</c>.
    /// </returns>
    public static bool IsWeek6(this DateTime dateTime)
    {
        return dateTime.DayOfWeek == DayOfWeek.Saturday;
    }

    /// <summary>
    /// Determines whether this instance is week7.
    /// </summary>
    /// <param name="dateTime">The date time.</param>
    /// <returns>
    ///   <c>true</c> if the specified date time is week7; otherwise, <c>false</c>.
    /// </returns>
    public static bool IsWeek7(this DateTime dateTime)
    {
